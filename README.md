...
4. Go to ffmpeg.org/download.html and install the .exe version, put it in the same directory as the main.py file.
5. Open notepad and drag and drop the .env file inside of it. Paste your bot token between the quotes and save as .env instead of the y.env.
